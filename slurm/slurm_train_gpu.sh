...
#################
# set a job name
#SBATCH --job-name=gscanseq2seq_gpu
#################
# a file for job output, you can check job progress
#SBATCH --output=gscanseq2seq_final_exp_gpu.out
#################
# a file for errors from the job
#SBATCH --error=gscanseq2seq_gpu.err
#################
...
srun python3.7 -m seq2seq --mode=train --max_testing_examples=2000 --data_directory=data/final_generalization_set --attention_type=bahdanau --no_auxiliary_task --conditional_attention --output_directory=final_generalization_exp_gpu --training_batch_size=50 --max_training_iterations=200000 &> final_generalization_exp_gpu/final_generalization_exp_gpu.txt
