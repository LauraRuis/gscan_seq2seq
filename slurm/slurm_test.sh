...
#SBATCH --output=gscanseq2seq_final_exp_test.out
#################
# a file for errors from the job
#SBATCH --error=gscanseq2seq_cpu_test.err
#################
...
srun python3.7 -m seq2seq --mode=test --data_directory=data/final_generalization_set --attention_type=bahdanau --no_auxiliary_task --conditional_attention --output_directory=final_generalization_exp --resume_from_file=final_generalization_exp/model_best.pth.tar &> final_generalization_exp/final_generalization_exp_test.txt
